...
export class BalanceSheetActiveReport {
onBack() {
throw new Error('Method not implemented.');
  ...
  async loadReport() {
    const reportResponse = await fetch("continuous_bs.rdlx-json");
