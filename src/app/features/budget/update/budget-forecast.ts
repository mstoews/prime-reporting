...
@Component({
  ...
  imports: [imp],
  template: `
                <grid-menubar  class="m-2" [showPeriod]="false"  [inTitle]="'Budget Forecast'" [showNew]=true [showSettings]="false"/>
                ...
                <ng-container>
                    <div class="border border-gray-500 ">
                        ...
                        <e-columns>
                            ...
                            <e-column headerText="Period 1" field="budget_1" width="120" textAlign="Right" format="N2">
                                <ng-template #footerTemplate let-data>{{data.budget_1 | number: '1.2-2'}}</ng-template>
                            </e-column>
                            <e-column headerText="Period 2" field="budget_2" width="120" textAlign="Right" format="N2">
                                <ng-template #footerTemplate let-data>{{data.budget_2 | number: '1.2-2'}}</ng-template>
                            </e-column>
                            <e-column headerText="Period 3" field="budget_3" width="120" textAlign="Right" format="N2">
                                <ng-template #footerTemplate let-data>{{data.budget_3 | number: '1.2-2'}}</ng-template>
                            </e-column>
                            <e-column headerText="Period 4" field="budget_4" width="120" textAlign="Right" format="N2">
                                <ng-template #footerTemplate let-data>{{data.budget_4 | number: '1.2-2'}}</ng-template>
                            </e-column>
                            <e-column headerText="Period 5" field="budget_5" width="120" textAlign="Right" format="N2">
                                <ng-template #footerTemplate let-data>{{data.budget_5 | number: '1.2-2'}}</ng-template>
                            </e-column>
                            <e-column headerText="Period 6" field="budget_6" width="120" textAlign="Right" format="N2">
                                <ng-template #footerTemplate let-data>{{data.budget_6 | number: '1.2-2'}}</ng-template>
                            </e-column>
                            <e-column headerText="Period 7" field="budget_7" width="120" textAlign="Right" format="N2">
                                <ng-template #footerTemplate let-data>{{data.budget_7 | number: '1.2-2'}}</ng-template>
                            </e-column>
                            <e-column headerText="Period 8" field="budget_8" width="120" textAlign="Right" format="N2">
                                <ng-template #footerTemplate let-data>{{data.budget_8 | number: '1.2-2'}}</ng-template>
                            </e-column>
                            <e-column headerText="Period 9" field="budget_9" width="120" textAlign="Right" format="N2">
                                <ng-template #footerTemplate let-data>{{data.budget_9 | number: '1.2-2'}}</ng-template>
                            </e-column>
                            <e-column headerText="Period 10" field="budget_10" width="120" textAlign="Right" format="N2">
                                  <ng-template #footerTemplate let-data>{{data.budget_10 | number: '1.2-2'}}</ng-template>
                            </e-column>
                            <e-column headerText="Period 11" field="budget_11" width="120" textAlign="Right" format="N2">
                                <ng-template #footerTemplate let-data>{{data.budget_11 | number: '1.2-2'}}</ng-template>
                            </e-column>
                            <e-column headerText="Period 12" field="budget_12" width="120" textAlign="Right" format="N2">
          ...
          <mat-card class="m-2">
              ...
              <form [formGroup]="budgetForm" class="form">
                  ...
                  <div class="flex flex-row w-full">
                      @if (bDirty === true) {
                      <button mat-icon-button color=primary class="bg-slate-200 hover:bg-slate-400 ml-1" matTooltip="Save" aria-label="hovered over">
...
export class BudgetForecast implements OnInit, OnDestroy, AfterViewInit {
